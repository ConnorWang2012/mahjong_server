...
void protobuf_AssignDesc_room_5fmsg_5fprotocol_2eproto() {
  ...
  static const int RoomMsgProtocol_offsets_[5] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, cur_players_num_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, max_players_num_),
  };
...
void protobuf_AddDesc_room_5fmsg_5fprotocol_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\rroom_owner_id\030\002 \002(\r\022\021\n\troom_type\030\003 \001(\r\022"
    "\027\n\017cur_players_num\030\004 \001(\r\022\027\n\017max_players_"
    "num\030\005 \001(\r", 169);
...
const int RoomMsgProtocol::kCurPlayersNumFieldNumber;
const int RoomMsgProtocol::kMaxPlayersNumFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_cur_players_num;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_max_players_num;
        break;
      }
      ...
      case 5: {
        if (tag == 40) {
         parse_max_players_num:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 input, &max_players_num_)));
...
void RoomMsgProtocol::SerializeWithCachedSizes(
  ...
  if (has_cur_players_num()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(4, this->cur_players_num(), output);
  }

  // optional uint32 max_players_num = 5;
  if (has_max_players_num()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(5, this->max_players_num(), output);
  }
...
::google::protobuf::uint8* RoomMsgProtocol::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 cur_players_num = 4;
  if (has_cur_players_num()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, this->cur_players_num(), target);
  }

  // optional uint32 max_players_num = 5;
  if (has_max_players_num()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(5, this->max_players_num(), target);
  }
...
void RoomMsgProtocol::MergeFrom(const RoomMsgProtocol& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_max_players_num()) {
      set_max_players_num(from.max_players_num());
    }
  }
...
void RoomMsgProtocol::Swap(RoomMsgProtocol* other) {
  if (other != this) {
    ...
    std::swap(max_players_num_, other->max_players_num_);
