...
void protobuf_AssignDesc_room_5fmsg_5fprotocol_2eproto() {
  ...
  static const int RoomMsgProtocol_offsets_[35] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, my_player_id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, my_visible_hand_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, my_invisible_hand_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, my_discards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, my_flower_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, my_season_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, my_waiting_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, left_player_id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, left_player_visible_hand_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, left_player_remain_hand_cards_num_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, left_player_discards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, left_player_flower_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, left_player_season_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, left_player_is_waiting_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, right_player_id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, right_player_visible_hand_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, right_player_remain_hand_cards_num_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, right_player_discards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, right_player_flower_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, right_player_season_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, right_player_is_waiting_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, opposite_player_id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, opposite_player_visible_hand_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, opposite_player_remain_hand_cards_num_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, opposite_player_discards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, opposite_player_flower_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, opposite_player_season_cards_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RoomMsgProtocol, opposite_player_is_waiting_),
  };
...
void protobuf_AddDesc_room_5fmsg_5fprotocol_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "l\"\317\010\n\017RoomMsgProtocol\022\017\n\007room_id\030\001 \002(\005\022\023"
    "\n\013players_num\030\002 \002(\005\022\021\n\tcur_round\030\003 \002(\005\022\023"
    "\n\013total_round\030\004 \002(\005\022\030\n\020remain_cards_num\030"
    "\005 \002(\005\022\034\n\024cur_acting_player_id\030\006 \002(\005\022\025\n\rc"
    "ur_action_id\030\007 \002(\005\022\024\n\014my_player_id\030\010 \002(\005"
    "\022\035\n\025my_visible_hand_cards\030\t \003(\005\022\037\n\027my_in"
    "visible_hand_cards\030\n \003(\005\022\023\n\013my_discards\030"
    "\013 \003(\005\022\027\n\017my_flower_cards\030\014 \003(\005\022\027\n\017my_sea"
    "son_cards\030\r \003(\005\022\030\n\020my_waiting_cards\030\016 \003("
    "\005\022\026\n\016left_player_id\030\017 \002(\005\022&\n\036left_player"
    "_visible_hand_cards\030\020 \003(\005\022)\n!left_player"
    "_remain_hand_cards_num\030\021 \002(\005\022\034\n\024left_pla"
    "yer_discards\030\022 \003(\005\022 \n\030left_player_flower"
    "_cards\030\023 \002(\005\022 \n\030left_player_season_cards"
    "\030\024 \002(\005\022\036\n\026left_player_is_waiting\030\025 \002(\010\022\027"
    "\n\017right_player_id\030\026 \002(\005\022\'\n\037right_player_"
    "visible_hand_cards\030\027 \003(\005\022*\n\"right_player"
    "_remain_hand_cards_num\030\030 \002(\005\022\035\n\025right_pl"
    "ayer_discards\030\031 \003(\005\022!\n\031right_player_flow"
    "er_cards\030\032 \002(\005\022!\n\031right_player_season_ca"
    "rds\030\033 \002(\005\022\037\n\027right_player_is_waiting\030\034 \002"
    "(\010\022\032\n\022opposite_player_id\030\035 \002(\005\022*\n\"opposi"
    "te_player_visible_hand_cards\030\036 \003(\005\022-\n%op"
    "posite_player_remain_hand_cards_num\030\037 \002("
    "\005\022 \n\030opposite_player_discards\030  \003(\005\022$\n\034o"
    "pposite_player_flower_cards\030! \002(\005\022$\n\034opp"
    "osite_player_season_cards\030\" \002(\005\022\"\n\032oppos"
    "ite_player_is_waiting\030# \002(\010", 1147);
...
const int RoomMsgProtocol::kMyPlayerIdFieldNumber;
const int RoomMsgProtocol::kMyVisibleHandCardsFieldNumber;
const int RoomMsgProtocol::kMyInvisibleHandCardsFieldNumber;
const int RoomMsgProtocol::kMyDiscardsFieldNumber;
const int RoomMsgProtocol::kMyFlowerCardsFieldNumber;
const int RoomMsgProtocol::kMySeasonCardsFieldNumber;
const int RoomMsgProtocol::kMyWaitingCardsFieldNumber;
const int RoomMsgProtocol::kLeftPlayerIdFieldNumber;
const int RoomMsgProtocol::kLeftPlayerVisibleHandCardsFieldNumber;
const int RoomMsgProtocol::kLeftPlayerRemainHandCardsNumFieldNumber;
const int RoomMsgProtocol::kLeftPlayerDiscardsFieldNumber;
const int RoomMsgProtocol::kLeftPlayerFlowerCardsFieldNumber;
const int RoomMsgProtocol::kLeftPlayerSeasonCardsFieldNumber;
const int RoomMsgProtocol::kLeftPlayerIsWaitingFieldNumber;
const int RoomMsgProtocol::kRightPlayerIdFieldNumber;
const int RoomMsgProtocol::kRightPlayerVisibleHandCardsFieldNumber;
const int RoomMsgProtocol::kRightPlayerRemainHandCardsNumFieldNumber;
const int RoomMsgProtocol::kRightPlayerDiscardsFieldNumber;
const int RoomMsgProtocol::kRightPlayerFlowerCardsFieldNumber;
const int RoomMsgProtocol::kRightPlayerSeasonCardsFieldNumber;
const int RoomMsgProtocol::kRightPlayerIsWaitingFieldNumber;
const int RoomMsgProtocol::kOppositePlayerIdFieldNumber;
const int RoomMsgProtocol::kOppositePlayerVisibleHandCardsFieldNumber;
const int RoomMsgProtocol::kOppositePlayerRemainHandCardsNumFieldNumber;
const int RoomMsgProtocol::kOppositePlayerDiscardsFieldNumber;
const int RoomMsgProtocol::kOppositePlayerFlowerCardsFieldNumber;
const int RoomMsgProtocol::kOppositePlayerSeasonCardsFieldNumber;
const int RoomMsgProtocol::kOppositePlayerIsWaitingFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_my_player_id;
        break;
      }
      ...
      case 14: {
        ...
        if (input->ExpectTag(112)) goto parse_my_waiting_cards;
        if (input->ExpectTag(120)) goto parse_left_player_id;
        break;
      }
      ...
      case 15: {
        if (tag == 120) {
         parse_left_player_id:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, &left_player_id_)));
      ...
      case 21: {
        ...
        if (input->ExpectTag(176)) goto parse_right_player_id;
        break;
      }
      ...
      case 22: {
        if (tag == 176) {
         parse_right_player_id:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, &right_player_id_)));
      ...
      case 28: {
        ...
        if (input->ExpectTag(232)) goto parse_opposite_player_id;
        break;
      }
      ...
      case 29: {
        if (tag == 232) {
         parse_opposite_player_id:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, &opposite_player_id_)));
...
void RoomMsgProtocol::SerializeWithCachedSizes(
  ...
  // required int32 my_player_id = 8;
  if (has_my_player_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(8, this->my_player_id(), output);
  }
  ...
  // required int32 left_player_id = 15;
  if (has_left_player_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(15, this->left_player_id(), output);
  }
  ...
  // required int32 right_player_id = 22;
  if (has_right_player_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(22, this->right_player_id(), output);
  }
  ...
  // required int32 opposite_player_id = 29;
  if (has_opposite_player_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(29, this->opposite_player_id(), output);
  }
...
::google::protobuf::uint8* RoomMsgProtocol::SerializeWithCachedSizesToArray(
  ...
  // required int32 my_player_id = 8;
  if (has_my_player_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(8, this->my_player_id(), target);
  }
  ...
  // required int32 left_player_id = 15;
  if (has_left_player_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(15, this->left_player_id(), target);
  }
  ...
  // required int32 right_player_id = 22;
  if (has_right_player_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(22, this->right_player_id(), target);
  }
  ...
  // required int32 opposite_player_id = 29;
  if (has_opposite_player_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(29, this->opposite_player_id(), target);
  }
...
void RoomMsgProtocol::MergeFrom(const RoomMsgProtocol& from) {
  ...
  if (from._has_bits_[14 / 32] & (0xffu << (14 % 32))) {
    if (from.has_left_player_id()) {
      set_left_player_id(from.left_player_id());
    }
  }
  if (from._has_bits_[16 / 32] & (0xffu << (16 % 32))) {
    ...
    if (from.has_right_player_id()) {
      set_right_player_id(from.right_player_id());
    }
  ...
  if (from._has_bits_[25 / 32] & (0xffu << (25 % 32))) {
    ...
    if (from.has_opposite_player_id()) {
      set_opposite_player_id(from.opposite_player_id());
    }
...
void RoomMsgProtocol::Swap(RoomMsgProtocol* other) {
  if (other != this) {
    ...
    std::swap(left_player_id_, other->left_player_id_);
    ...
    std::swap(right_player_id_, other->right_player_id_);
    ...
    std::swap(opposite_player_id_, other->opposite_player_id_);
