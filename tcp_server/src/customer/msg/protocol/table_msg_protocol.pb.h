...
class TableMsgProtocol : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_required_players_num() const;
  inline void clear_required_players_num();
  static const int kRequiredPlayersNumFieldNumber = 2;
  inline ::google::protobuf::uint32 required_players_num() const;
  inline void set_required_players_num(::google::protobuf::uint32 value);
  ...
  static const int kBankerIsSameTimeFieldNumber = 7;
  ...
  static const int kOperatingPlayerIdFieldNumber = 8;
  ...
  static const int kRemainCardsFieldNumber = 10;
  ...
  static const int kPlayersFieldNumber = 12;
 ...
 private:
  ...
  inline void set_has_required_players_num();
  inline void clear_has_required_players_num();
  ...
  ::google::protobuf::uint32 required_players_num_;
...
// required uint32 required_players_num = 2;
inline bool TableMsgProtocol::has_required_players_num() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void TableMsgProtocol::set_has_required_players_num() {
  _has_bits_[0] |= 0x00000002u;
}
inline void TableMsgProtocol::clear_has_required_players_num() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void TableMsgProtocol::clear_required_players_num() {
  required_players_num_ = 0u;
  clear_has_required_players_num();
}
inline ::google::protobuf::uint32 TableMsgProtocol::required_players_num() const {
  // @@protoc_insertion_point(field_get:gamer.protocol.TableMsgProtocol.required_players_num)
  return required_players_num_;
}
inline void TableMsgProtocol::set_required_players_num(::google::protobuf::uint32 value) {
  set_has_required_players_num();
  required_players_num_ = value;
  // @@protoc_insertion_point(field_set:gamer.protocol.TableMsgProtocol.required_players_num)
}
